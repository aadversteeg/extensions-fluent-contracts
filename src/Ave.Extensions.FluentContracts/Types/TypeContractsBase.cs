...
{
    /// <summary>
    /// Base class for Type contracts containing all contract methods.
    /// </summary>
    /// <typeparam name="TSelf">The concrete contract type for fluent chaining.</typeparam>
    public abstract class TypeContractsBase<TSelf> : Contracts<Type?, TSelf>
        where TSelf : TypeContractsBase<TSelf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TypeContractsBase{TSelf}"/> class.
        /// </summary>
        ...
        protected TypeContractsBase(Type? subject, bool throwOnFailure)
        ...
        public TSelf BeAssignableTo(Type type, string because = "", params object[] becauseArgs)
        {
            ...
            return Assert(
                ...
                TypeContractCodes.BeAssignableTo,
                Subject is not null
        ...
        public TSelf NotBeAssignableTo(Type type, string because = "", params object[] becauseArgs)
        {
            ...
            return Assert(
                ...
                TypeContractCodes.NotBeAssignableTo,
        ...
        public TSelf NotImplement(Type interfaceType, string because = "", params object[] becauseArgs)
        {
            ...
            return Assert(
                ...
                TypeContractCodes.NotImplement,
        ...
        public TSelf BeDerivedFrom(Type baseType, string because = "", params object[] becauseArgs)
        {
            ...
            return Assert(
                ...
                TypeContractCodes.BeDerivedFrom,
                Subject is not null
        ...
        public TSelf NotBeDerivedFrom(Type baseType, string because = "", params object[] becauseArgs)
        {
            ...
            return Assert(
                ...
                TypeContractCodes.NotBeDerivedFrom,
        ...
        public TSelf NotBeAbstract(string because = "", params object[] becauseArgs)
        {
            return Assert(
                s => s is not null && (!s.IsAbstract || !s.IsClass),
                TypeContractCodes.NotBeAbstract,
                Subject is not null
        ...
        public TSelf NotBeInterface(string because = "", params object[] becauseArgs)
        {
            return Assert(
                s => s is not null && !s.IsInterface,
                TypeContractCodes.NotBeInterface,
                Subject is not null
            ...
            where TAttribute : Attribute
        {
            return Assert(
                ...
                TypeContractCodes.BeDecoratedWith,
                Subject is not null
            ...
            where TAttribute : Attribute
        {
            return Assert(
                ...
                TypeContractCodes.NotBeDecoratedWith,
        ...
        public TSelf HaveDefaultConstructor(string because = "", params object[] becauseArgs)
        {
            return Assert(
                ...
                TypeContractCodes.HaveDefaultConstructor,
                Subject is not null
        ...
        public TSelf NotHaveDefaultConstructor(string because = "", params object[] becauseArgs)
        {
            return Assert(
                ...
                TypeContractCodes.NotHaveDefaultConstructor,
                Subject is not null
