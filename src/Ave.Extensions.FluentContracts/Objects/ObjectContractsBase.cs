...
{
    /// <summary>
    /// Base class for object contracts containing all contract methods.
    /// </summary>
    /// <typeparam name="TSelf">The concrete contract type for fluent chaining.</typeparam>
    public abstract class ObjectContractsBase<TSelf> : Contracts<object?, TSelf>
        where TSelf : ObjectContractsBase<TSelf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectContractsBase{TSelf}"/> class.
        /// </summary>
        ...
        protected ObjectContractsBase(object? subject, bool throwOnFailure)
            ...
            params object[] becauseArgs)
        {
            return Assert(
                ...
                ObjectContractCodes.NotBeSameAs,
            ...
            params object[] becauseArgs)
        {
            ...
            return Assert(
                ...
                ObjectContractCodes.NotBeOfType,
            ...
            params object[] becauseArgs)
        {
            ...
            return Assert(
                ...
                ObjectContractCodes.BeAssignableTo,
                Subject is null
            ...
            params object[] becauseArgs)
        {
            ...
            return Assert(
                ...
                ObjectContractCodes.NotBeAssignableTo,
