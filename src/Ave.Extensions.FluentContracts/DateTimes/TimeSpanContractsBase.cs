...
{
    /// <summary>
    /// Base class for TimeSpan contracts containing all contract methods.
    /// </summary>
    /// <typeparam name="TSelf">The concrete contract type for fluent chaining.</typeparam>
    public abstract class TimeSpanContractsBase<TSelf> : Contracts<TimeSpan?, TSelf>
        where TSelf : TimeSpanContractsBase<TSelf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeSpanContractsBase{TSelf}"/> class.
        /// </summary>
        ...
        protected TimeSpanContractsBase(TimeSpan? subject, bool throwOnFailure)
        ...
        public TSelf HaveValue(string because = "", params object[] becauseArgs)
        {
            return Assert(
                s => s.HasValue,
                TimeSpanContractCodes.HaveValue,
        ...
        public TSelf NotHaveValue(string because = "", params object[] becauseArgs)
        {
            return Assert(
                s => !s.HasValue,
                TimeSpanContractCodes.NotHaveValue,
        ...
        public TSelf BePositive(string because = "", params object[] becauseArgs)
        {
            return Assert(
                ...
                TimeSpanContractCodes.BePositive,
                Subject.HasValue
        ...
        public TSelf BeNegative(string because = "", params object[] becauseArgs)
        {
            return Assert(
                s => s.HasValue && s.Value < TimeSpan.Zero,
                TimeSpanContractCodes.BeNegative,
                Subject.HasValue
        ...
        public TSelf BeGreaterThan(TimeSpan expected, string because = "", params object[] becauseArgs)
        {
            return Assert(
                s => s.HasValue && s.Value > expected,
                TimeSpanContractCodes.BeGreaterThan,
                Subject.HasValue
        ...
        public TSelf BeGreaterThanOrEqualTo(TimeSpan expected, string because = "", params object[] becauseArgs)
        {
            return Assert(
                s => s.HasValue && s.Value >= expected,
                TimeSpanContractCodes.BeGreaterThanOrEqualTo,
                Subject.HasValue
        ...
        public TSelf BeLessThan(TimeSpan expected, string because = "", params object[] becauseArgs)
        {
            return Assert(
                s => s.HasValue && s.Value < expected,
                TimeSpanContractCodes.BeLessThan,
                Subject.HasValue
        ...
        public TSelf BeLessThanOrEqualTo(TimeSpan expected, string because = "", params object[] becauseArgs)
        {
            return Assert(
                s => s.HasValue && s.Value <= expected,
                TimeSpanContractCodes.BeLessThanOrEqualTo,
                Subject.HasValue
        ...
        public TSelf BeCloseTo(TimeSpan expected, TimeSpan precision, string because = "", params object[] becauseArgs)
        {
            return Assert(
                ...
                TimeSpanContractCodes.BeCloseTo,
                Subject.HasValue
        ...
        public TSelf NotBeCloseTo(TimeSpan unexpected, TimeSpan precision, string because = "", params object[] becauseArgs)
        {
            return Assert(
                ...
                TimeSpanContractCodes.NotBeCloseTo,
