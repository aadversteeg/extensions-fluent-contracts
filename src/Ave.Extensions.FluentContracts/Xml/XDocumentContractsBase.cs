...
{
    /// <summary>
    /// Base class for XDocument contracts containing all contract methods.
    /// </summary>
    /// <typeparam name="TSelf">The concrete contract type for fluent chaining.</typeparam>
    public abstract class XDocumentContractsBase<TSelf> : Contracts<XDocument?, TSelf>
        where TSelf : XDocumentContractsBase<TSelf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XDocumentContractsBase{TSelf}"/> class.
        /// </summary>
        ...
        protected XDocumentContractsBase(XDocument? subject, bool throwOnFailure)
        ...
        public TSelf BeEquivalentTo(XDocument? expected, string because = "", params object[] becauseArgs)
        {
            return Assert(
                ...
                XmlContractCodes.BeEquivalentTo,
                Subject is null
        ...
        public TSelf NotBeEquivalentTo(XDocument? unexpected, string because = "", params object[] becauseArgs)
        {
            return Assert(
                ...
                XmlContractCodes.NotBeEquivalentTo,
