...
{
    /// <summary>
    /// Base class for XElement contracts containing all contract methods.
    /// </summary>
    /// <typeparam name="TSelf">The concrete contract type for fluent chaining.</typeparam>
    public abstract class XElementContractsBase<TSelf> : Contracts<XElement?, TSelf>
        where TSelf : XElementContractsBase<TSelf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XElementContractsBase{TSelf}"/> class.
        /// </summary>
        ...
        protected XElementContractsBase(XElement? subject, bool throwOnFailure)
        ...
        public TSelf HaveAttribute(XName expectedName, string expectedValue, string because = "", params object[] becauseArgs)
        {
            ...
            return Assert(
                ...
                XmlContractCodes.HaveAttribute,
                Subject is null
