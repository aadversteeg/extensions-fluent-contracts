...
{
    /// <summary>
    /// Base class for boolean contracts containing all contract methods.
    /// </summary>
    /// <typeparam name="TSelf">The concrete contract type for fluent chaining.</typeparam>
    public abstract class BooleanContractsBase<TSelf> : Contracts<bool, TSelf>
        where TSelf : BooleanContractsBase<TSelf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BooleanContractsBase{TSelf}"/> class.
        /// </summary>
        ...
        protected BooleanContractsBase(bool subject, bool throwOnFailure)
