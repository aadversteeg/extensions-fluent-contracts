...
{
    /// <summary>
    /// Base class containing contract methods for string collections.
    /// </summary>
    /// <typeparam name="TSelf">The concrete contract type (CRTP pattern for fluent chaining).</typeparam>
    public abstract class StringCollectionContractsBase<TSelf> : Contracts<IEnumerable<string?>?, TSelf>
        where TSelf : StringCollectionContractsBase<TSelf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StringCollectionContractsBase{TSelf}"/> class.
        /// </summary>
        ...
        protected StringCollectionContractsBase(IEnumerable<string?>? subject, bool throwOnFailure) : base(subject, throwOnFailure)
        {
        }
        ...
        public TSelf BeEmpty(string because = "", params object[] becauseArgs)
        {
            return Assert(
                ...
                StringCollectionContractCodes.BeEmpty,
                Subject is null
        ...
        public TSelf NotBeEmpty(string because = "", params object[] becauseArgs)
        {
            return Assert(
                s => s is not null && s.Any(),
                StringCollectionContractCodes.NotBeEmpty,
                Subject is null
        ...
        public TSelf HaveCount(int expected, string because = "", params object[] becauseArgs)
        {
            return Assert(
                ...
                StringCollectionContractCodes.HaveCount,
                Subject is null
        ...
        public TSelf Contain(string? expected, string because = "", params object[] becauseArgs)
        {
            return Assert(
                ...
                StringCollectionContractCodes.Contain,
                Subject is null
        ...
        public TSelf NotContain(string? unexpected, string because = "", params object[] becauseArgs)
        {
            return Assert(
                ...
                StringCollectionContractCodes.NotContain,
        ...
        public TSelf ContainMatch(string wildcardPattern, string because = "", params object[] becauseArgs)
        {
            ...
            return Assert(
                ...
                StringCollectionContractCodes.ContainMatch,
                Subject is null
        ...
        public TSelf NotContainMatch(string wildcardPattern, string because = "", params object[] becauseArgs)
        {
            ...
            return Assert(
                ...
                StringCollectionContractCodes.NotContainMatch,
        ...
        public TSelf AllMatch(string wildcardPattern, string because = "", params object[] becauseArgs)
        {
            ...
            return Assert(
                ...
                StringCollectionContractCodes.AllMatch,
                Subject is null
        ...
        public TSelf ContainEquivalentOf(string? expected, string because = "", params object[] becauseArgs)
        {
            return Assert(
                ...
                StringCollectionContractCodes.ContainEquivalentOf,
                Subject is null
        ...
        public TSelf NotContainEquivalentOf(string? unexpected, string because = "", params object[] becauseArgs)
        {
            return Assert(
                ...
                StringCollectionContractCodes.NotContainEquivalentOf,
        ...
        public TSelf OnlyContainNullOrEmpty(string because = "", params object[] becauseArgs)
        {
            return Assert(
                ...
                StringCollectionContractCodes.OnlyContainNullOrEmpty,
                Subject is null
        ...
        public TSelf NotContainNullOrEmpty(string because = "", params object[] becauseArgs)
        {
            return Assert(
                ...
                StringCollectionContractCodes.NotContainNullOrEmpty,
                Subject is null
        ...
        public TSelf Equal(IEnumerable<string?> expected, string because = "", params object[] becauseArgs)
        {
            ...
            return Assert(
                ...
                StringCollectionContractCodes.Equal,
                Subject is null
        ...
        public TSelf HaveCountGreaterThan(int expected, string because = "", params object[] becauseArgs)
        {
            return Assert(
                s => s is not null && s.Count() > expected,
                CollectionContractCodes.HaveCountGreaterThan,
                Subject is null
        ...
        public TSelf HaveCountLessThan(int expected, string because = "", params object[] becauseArgs)
        {
            return Assert(
                s => s is not null && s.Count() < expected,
                CollectionContractCodes.HaveCountLessThan,
                Subject is null
        ...
        public TSelf ContainSingle(string because = "", params object[] becauseArgs)
        {
            return Assert(
                ...
                CollectionContractCodes.ContainSingle,
                Subject is null
        ...
        public TSelf OnlyContain(Func<string?, bool> predicate, string because = "", params object[] becauseArgs)
        {
            ...
            return Assert(
                ...
                CollectionContractCodes.OnlyContain,
        ...
        public TSelf BeSubsetOf(IEnumerable<string?> expectedSuperset, string because = "", params object[] becauseArgs)
        {
            ...
            return Assert(
                ...
                CollectionContractCodes.BeSubsetOf,
        ...
        public TSelf HaveElementAt(int index, string? expected, string because = "", params object[] becauseArgs)
        {
            return Assert(
                ...
                CollectionContractCodes.HaveElementAt,
                Subject is null
        ...
        public TSelf BeInAscendingOrder(string because = "", params object[] becauseArgs)
        {
            return Assert(
                ...
                CollectionContractCodes.BeInAscendingOrder,
        ...
        public TSelf BeInDescendingOrder(string because = "", params object[] becauseArgs)
        {
            return Assert(
                ...
                CollectionContractCodes.BeInDescendingOrder,
