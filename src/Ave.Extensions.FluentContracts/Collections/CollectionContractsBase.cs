...
{
    /// <summary>
    /// Base class containing contract methods for collections.
    /// </summary>
    /// <typeparam name="T">The type of elements in the collection.</typeparam>
    /// <typeparam name="TSelf">The concrete contract type (CRTP pattern for fluent chaining).</typeparam>
    public abstract class CollectionContractsBase<T, TSelf> : Contracts<IEnumerable<T>?, TSelf>
        where TSelf : CollectionContractsBase<T, TSelf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectionContractsBase{T, TSelf}"/> class.
        /// </summary>
        ...
        protected CollectionContractsBase(IEnumerable<T>? subject, bool throwOnFailure) : base(subject, throwOnFailure)
        {
        }
        ...
        public TSelf BeEmpty(string because = "", params object[] becauseArgs)
        {
            return Assert(
                ...
                CollectionContractCodes.BeEmpty,
                Subject is null
        ...
        public TSelf NotBeEmpty(string because = "", params object[] becauseArgs)
        {
            return Assert(
                s => s is not null && s.Any(),
                CollectionContractCodes.NotBeEmpty,
                Subject is null
        ...
        public TSelf HaveCount(int expected, string because = "", params object[] becauseArgs)
        {
            return Assert(
                ...
                CollectionContractCodes.HaveCount,
                Subject is null
        ...
        public TSelf Contain(T expected, string because = "", params object[] becauseArgs)
        {
            return Assert(
                ...
                CollectionContractCodes.Contain,
                Subject is null
        ...
        public TSelf NotContain(T unexpected, string because = "", params object[] becauseArgs)
        {
            return Assert(
                ...
                CollectionContractCodes.NotContain,
