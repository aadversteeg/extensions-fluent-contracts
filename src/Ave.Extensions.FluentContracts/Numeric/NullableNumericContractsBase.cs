...
{
    /// <summary>
    /// Base class for nullable numeric contracts containing all contract methods.
    /// </summary>
    /// <typeparam name="T">The numeric type.</typeparam>
    /// <typeparam name="TSelf">The concrete contract type for fluent chaining.</typeparam>
    public abstract class NullableNumericContractsBase<T, TSelf> : Contracts<T?, TSelf>
        where T : struct, IComparable<T>
        where TSelf : NullableNumericContractsBase<T, TSelf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NullableNumericContractsBase{T, TSelf}"/> class.
        /// </summary>
        ...
        protected NullableNumericContractsBase(T? subject, bool throwOnFailure)
        ...
        public TSelf HaveValue(string because = "", params object[] becauseArgs)
        {
            return Assert(
                s => s.HasValue,
                NumericContractCodes.HaveValue,
        ...
        public TSelf NotHaveValue(string because = "", params object[] becauseArgs)
        {
            return Assert(
                s => !s.HasValue,
                NumericContractCodes.NotHaveValue,
        ...
        public TSelf BePositive(string because = "", params object[] becauseArgs)
        {
            return Assert(
                ...
                NumericContractCodes.BePositive,
                Subject.HasValue
        ...
        public TSelf BeNegative(string because = "", params object[] becauseArgs)
        {
            return Assert(
                s => s.HasValue && s.Value.CompareTo(default!) < 0,
                NumericContractCodes.BeNegative,
                Subject.HasValue
        ...
        public TSelf BeGreaterThan(T expected, string because = "", params object[] becauseArgs)
        {
            return Assert(
                s => s.HasValue && s.Value.CompareTo(expected) > 0,
                NumericContractCodes.BeGreaterThan,
                Subject.HasValue
        ...
        public TSelf BeGreaterThanOrEqualTo(T expected, string because = "", params object[] becauseArgs)
        {
            return Assert(
                s => s.HasValue && s.Value.CompareTo(expected) >= 0,
                NumericContractCodes.BeGreaterThanOrEqualTo,
                Subject.HasValue
        ...
        public TSelf BeLessThan(T expected, string because = "", params object[] becauseArgs)
        {
            return Assert(
                s => s.HasValue && s.Value.CompareTo(expected) < 0,
                NumericContractCodes.BeLessThan,
                Subject.HasValue
        ...
        public TSelf BeLessThanOrEqualTo(T expected, string because = "", params object[] becauseArgs)
        {
            return Assert(
                s => s.HasValue && s.Value.CompareTo(expected) <= 0,
                NumericContractCodes.BeLessThanOrEqualTo,
                Subject.HasValue
        ...
        public TSelf BeInRange(T minimumValue, T maximumValue, string because = "", params object[] becauseArgs)
        {
            return Assert(
                ...
                NumericContractCodes.BeInRange,
                Subject.HasValue
        ...
        public TSelf NotBeInRange(T minimumValue, T maximumValue, string because = "", params object[] becauseArgs)
        {
            return Assert(
                s => !s.HasValue || s.Value.CompareTo(minimumValue) < 0 || s.Value.CompareTo(maximumValue) > 0,
                NumericContractCodes.NotBeInRange,
                Subject.HasValue
