...
{
    /// <summary>
    /// Base class for numeric contracts containing all contract methods.
    /// </summary>
    /// <typeparam name="T">The numeric type.</typeparam>
    /// <typeparam name="TSelf">The concrete contract type for fluent chaining.</typeparam>
    public abstract class NumericContractsBase<T, TSelf> : Contracts<T, TSelf>
        where T : struct, IComparable<T>
        where TSelf : NumericContractsBase<T, TSelf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NumericContractsBase{T, TSelf}"/> class.
        /// </summary>
        ...
        protected NumericContractsBase(T subject, bool throwOnFailure)
