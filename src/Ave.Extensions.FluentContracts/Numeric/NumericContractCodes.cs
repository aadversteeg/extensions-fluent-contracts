...
{
    /// <summary>
    /// Error codes for numeric contracts.
    /// </summary>
    public static class NumericContractCodes
    {
        /// <summary>
        /// Root error code for numeric contracts.
        /// </summary>
        public static readonly ErrorCode _ = ContractCodes._ / "Numeric";
