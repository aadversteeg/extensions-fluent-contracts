...
{
    /// <summary>
    /// Base class containing contract methods for Func{T} delegates.
    /// </summary>
    /// <typeparam name="T">The return type of the function.</typeparam>
    /// <typeparam name="TSelf">The concrete contract type (CRTP pattern for fluent chaining).</typeparam>
    public abstract class FunctionContractsBase<T, TSelf> : Contracts<Func<T>, TSelf>
        where TSelf : FunctionContractsBase<T, TSelf>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FunctionContractsBase{T, TSelf}"/> class.
        /// </summary>
        ...
        protected FunctionContractsBase(Func<T> func, bool throwOnFailure) : base(func, throwOnFailure)
        {
        }
        ...
        /// <returns>An ExceptionContracts object to further check the thrown exception.</returns>
            ...
            where TException : Exception
        {
            ...
            if (_capturedException is null)
            {
                ...
                return CreateFailedExceptionContracts<TException>(error, because, becauseArgs);
            }
            ...
            return new ExceptionContracts<TException>((TException)_capturedException);
        }
        ...
        public TSelf NotReturn(T unexpected, string because = "", params object[] becauseArgs)
        {
            ...
            return Assert(
                ...
                FunctionContractCodes.NotReturn,
        ...
        public TSelf ReturnNotNull(string because = "", params object[] becauseArgs)
        {
            ...
            if (_capturedException is not null)
            {
                return Assert(
                    _ => false,
                    FunctionContractCodes.ReturnNotNull,
        ...
        public TSelf ReturnNull(string because = "", params object[] becauseArgs)
        {
            ...
            if (_capturedException is not null)
            {
                return Assert(
                    _ => false,
                    FunctionContractCodes.ReturnNull,
        ...
        private static ExceptionContracts<TException> CreateFailedExceptionContracts<TException>(
            Error error, string because, object[] becauseArgs)
            where TException : Exception
        {
            var reason = FormatBecause(because, becauseArgs);
            var contracts = new ExceptionContracts<TException>(null);
