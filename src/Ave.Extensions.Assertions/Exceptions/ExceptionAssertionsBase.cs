...
namespace Ave.Extensions.Assertions.Exceptions
{
    ...
    public abstract class ExceptionAssertionsBase<TException, TSelf> : Assertions<TException?, TSelf>
        where TException : Exception
        where TSelf : ExceptionAssertionsBase<TException, TSelf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExceptionAssertionsBase{TException, TSelf}"/> class.
        /// </summary>
        ...
        protected ExceptionAssertionsBase(TException? exception, bool throwOnFailure)
        ...
        public TSelf WithMessage(string expectedMessage, string because = "", params object[] becauseArgs)
        {
            return Assert(
                ...
                ExceptionAssertionCodes.WithMessage,
                Subject is not null
            ...
            where TInnerException : Exception
        {
            return Assert(
                ...
                ExceptionAssertionCodes.WithInnerException,
                Subject is not null
