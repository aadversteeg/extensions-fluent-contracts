...
namespace Ave.Extensions.Assertions
{
    ...
    /// </summary>
    public sealed class BooleanAssertions : BooleanAssertionsBase<BooleanAssertions>
    {
        /// <summary>
        ...
        public BooleanAssertions(bool subject) : base(subject, throwOnFailure: false)
        {
        }
        ...
        public static implicit operator Result<bool, Error>(BooleanAssertions assertions)
        {
        ...
        public static implicit operator VoidResult<Error>(BooleanAssertions assertions)
        {
