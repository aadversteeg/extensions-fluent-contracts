...
namespace Ave.Extensions.Assertions
{
    ...
    public sealed class NumericAssertions<T> : NumericAssertionsBase<T, NumericAssertions<T>>
        where T : struct, IComparable<T>
    {
        ...
        public NumericAssertions(T subject) : base(subject, throwOnFailure: false)
        {
        }
        ...
        public static implicit operator Result<T, Error>(NumericAssertions<T> assertions)
        {
        ...
        public static implicit operator VoidResult<Error>(NumericAssertions<T> assertions)
        {
