...
namespace Ave.Extensions.Assertions
{
    ...
    /// </summary>
    public sealed class TimeSpanAssertions : TimeSpanAssertionsBase<TimeSpanAssertions>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeSpanAssertions"/> class.
        /// </summary>
        /// <param name="subject">The TimeSpan value to assert on.</param>
        public TimeSpanAssertions(TimeSpan? subject) : base(subject, throwOnFailure: false)
        {
        }
        ...
        public static implicit operator Result<TimeSpan?, Error>(TimeSpanAssertions assertions)
        {
        ...
        public static implicit operator VoidResult<Error>(TimeSpanAssertions assertions)
        {
