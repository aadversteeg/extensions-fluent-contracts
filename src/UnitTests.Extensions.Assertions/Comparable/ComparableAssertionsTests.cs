using System;
using Ave.Extensions.Assertions.Comparable;
using Ave.Extensions.ErrorPaths;
using Ave.Extensions.Functional;
using Xunit;

namespace UnitTests.Extensions.Assertions.Comparable
{
    public class ComparableAssertionsTests
    {
        ...
        public void CA002()
        {
            ...
            Assert.Equal(ComparableAssertionCodes.Be, result.Error.Code);
        }
        ...
        public void CA004()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(ComparableAssertionCodes.NotBe, result.Error.Code);
        }
        ...
        public void CA006()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(ComparableAssertionCodes.BeRankedEquallyTo, result.Error.Code);
        }
        ...
        public void CA008()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(ComparableAssertionCodes.NotBeRankedEquallyTo, result.Error.Code);
        }
        ...
        public void CA010()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(ComparableAssertionCodes.BeGreaterThan, result.Error.Code);
        }
        ...
        public void CA014()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(ComparableAssertionCodes.BeGreaterThanOrEqualTo, result.Error.Code);
        }
        ...
        public void CA016()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(ComparableAssertionCodes.BeLessThan, result.Error.Code);
        }
        ...
        public void CA020()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(ComparableAssertionCodes.BeLessThanOrEqualTo, result.Error.Code);
        }
        ...
        public void CA024()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(ComparableAssertionCodes.BeInRange, result.Error.Code);
        }
        ...
        public void CA028()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(ComparableAssertionCodes.NotBeInRange, result.Error.Code);
        }
        ...
        public void CA030()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(ComparableAssertionCodes.BeOneOf, result.Error.Code);
        }
        ...
        [Fact(DisplayName = "CA-031: Chained assertions all pass")]
        public void CA031()
        {
            // Arrange
            var subject = new ComparableValue(50);
        ...
        [Fact(DisplayName = "CA-032: Chained assertions fail on second assertion")]
        public void CA032()
        {
            // Arrange
            var subject = new ComparableValue(50);
