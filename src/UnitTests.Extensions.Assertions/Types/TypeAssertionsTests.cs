...
using Ave.Extensions.Assertions.Types;
using Ave.Extensions.ErrorPaths;
using Ave.Extensions.Functional;
using Xunit;

namespace UnitTests.Extensions.Assertions.Types
{
    public class TypeAssertionsTests
    {
        ...
        public void TY002()
        {
            ...
            Assert.Equal(TypeAssertionCodes.Be, result.Error.Code);
        }
        ...
        public void TY005()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(TypeAssertionCodes.NotBe, result.Error.Code);
        }
        ...
        public void TY007()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(TypeAssertionCodes.BeAssignableTo, result.Error.Code);
        }
        ...
        public void TY011()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(TypeAssertionCodes.Implement, result.Error.Code);
        }
        ...
        public void TY015()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(TypeAssertionCodes.BeDerivedFrom, result.Error.Code);
        }
        ...
        public void TY019()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(TypeAssertionCodes.BeSealed, result.Error.Code);
        }
        ...
        public void TY022()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(TypeAssertionCodes.BeAbstract, result.Error.Code);
        }
        ...
        public void TY025()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(TypeAssertionCodes.BeInterface, result.Error.Code);
        }
        ...
        public void TY028()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(TypeAssertionCodes.BeClass, result.Error.Code);
        }
        ...
        public void TY031()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(TypeAssertionCodes.BeDecoratedWith, result.Error.Code);
        }
        ...
        public void TY034()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(TypeAssertionCodes.HaveDefaultConstructor, result.Error.Code);
        }
        ...
        [Fact(DisplayName = "TY-036: Chaining multiple type assertions works")]
        public void TY036()
        {
            // Arrange
            var subject = typeof(DerivedClass);
