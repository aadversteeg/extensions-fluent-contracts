using System;
using Ave.Extensions.Assertions.Enums;
using Ave.Extensions.ErrorPaths;
using Ave.Extensions.Functional;
using Xunit;

namespace UnitTests.Extensions.Assertions.Enums
{
    public class EnumAssertionsTests
    {
        ...
        public void EN002()
        {
            ...
            Assert.Equal(EnumAssertionCodes.Be, result.Error.Code);
        }
        ...
        public void EN004()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(EnumAssertionCodes.NotBe, result.Error.Code);
        }
        ...
        public void EN006()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(EnumAssertionCodes.BeDefined, result.Error.Code);
        }
        ...
        public void EN008()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(EnumAssertionCodes.NotBeDefined, result.Error.Code);
        }
        ...
        public void EN010()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(EnumAssertionCodes.HaveValue, result.Error.Code);
        }
        ...
        public void EN013()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(EnumAssertionCodes.HaveSameValueAs, result.Error.Code);
        }
        ...
        public void EN016()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(EnumAssertionCodes.HaveSameNameAs, result.Error.Code);
        }
        ...
        public void EN019()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(EnumAssertionCodes.HaveFlag, result.Error.Code);
        }
        ...
        public void EN021()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(EnumAssertionCodes.NotHaveFlag, result.Error.Code);
        }
        ...
        public void EN023()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(EnumAssertionCodes.Match, result.Error.Code);
        }
        ...
        public void EN026()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(EnumAssertionCodes.BeOneOf, result.Error.Code);
        }
        ...
        [Fact(DisplayName = "EN-030: Chaining multiple enum assertions works")]
        public void EN030()
        {
            // Arrange
            var subject = TestEnum.Second;
