...
namespace UnitTests.Extensions.Assertions.Functions
{
    public class FunctionAssertionsTests
    {
        ...
        public void FA002()
        {
            ...
            Assert.Equal(FunctionAssertionCodes.Return, result.Error.Code);
        }
        ...
        public void FA005()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(FunctionAssertionCodes.NotReturn, result.Error.Code);
        }
        ...
        public void FA007()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(FunctionAssertionCodes.ReturnNotNull, result.Error.Code);
        }
        ...
        public void FA010()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(FunctionAssertionCodes.ReturnNull, result.Error.Code);
        }
        ...
        public void FA012()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(FunctionAssertionCodes.Satisfy, result.Error.Code);
        }
        ...
        public void FA015()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(FunctionAssertionCodes.NotThrow, result.Error.Code);
        }
        ...
        public void FA019()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(FunctionAssertionCodes.Throw, result.Error.Code);
        }
        ...
        public void FA023()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(FunctionAssertionCodes.ThrowExactly, result.Error.Code);
        }
        ...
        [Fact(DisplayName = "FA-026: Chaining function assertions works")]
        public void FA026()
        {
            // Arrange
            Func<int> func = () => 42;
        ...
        public void FA027()
        {
            // Arrange
            Func<int> func = () => 42;
            var assertions = func.Should();

            // Act
            assertions.NotThrow();
            var value = assertions.GetResult();
