...
namespace UnitTests.FluentContracts.ForValidation.Dictionaries
{
    public class DictionaryContractsTests
    {
        ...
        public void DA002()
        {
            ...
            Assert.Equal(DictionaryContractCodes.BeNull, result.Error.Code);
        }
        ...
        public void DA004()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(DictionaryContractCodes.NotBeNull, result.Error.Code);
        }
        ...
        public void DA006()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(DictionaryContractCodes.BeEmpty, result.Error.Code);
        }
        ...
        public void DA008()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(DictionaryContractCodes.NotBeEmpty, result.Error.Code);
        }
        ...
        public void DA010()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(DictionaryContractCodes.HaveCount, result.Error.Code);
        }
        ...
        public void DA012()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(DictionaryContractCodes.ContainKey, result.Error.Code);
        }
        ...
        public void DA014()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(DictionaryContractCodes.NotContainKey, result.Error.Code);
        }
        ...
        public void DA016()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(DictionaryContractCodes.ContainKeys, result.Error.Code);
        }
        ...
        public void DA018()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(DictionaryContractCodes.ContainValue, result.Error.Code);
        }
        ...
        public void DA020()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(DictionaryContractCodes.NotContainValue, result.Error.Code);
        }
        ...
        public void DA022()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(DictionaryContractCodes.ContainKeyValuePair, result.Error.Code);
        }
        ...
        public void DA025()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(DictionaryContractCodes.NotContainKeyValuePair, result.Error.Code);
        }
        ...
        public void DA027()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(DictionaryContractCodes.HaveSameCount, result.Error.Code);
        }
        ...
        [Fact(DisplayName = "DA-028: Chaining dictionary contracts works")]
        public void DA028()
        {
            // Arrange
            var subject = new Dictionary<string, int> { { "a", 1 }, { "b", 2 }, { "c", 3 } };
