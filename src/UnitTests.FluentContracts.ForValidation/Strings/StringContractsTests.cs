...
namespace UnitTests.FluentContracts.ForValidation.Strings
{
    public class StringContractsTests
    {
        #region Be / NotBe
        ...
        public void SA002()
        {
            ...
            Assert.Equal(StringContractCodes.Be, result.Error.Code);
        }
        ...
        public void SA004()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(StringContractCodes.NotBe, result.Error.Code);
        }
        ...
        public void SA006()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(StringContractCodes.BeEmpty, result.Error.Code);
        }
        ...
        public void SA008()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(StringContractCodes.NotBeEmpty, result.Error.Code);
        }
        ...
        public void SA011()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(StringContractCodes.BeNullOrEmpty, result.Error.Code);
        }
        ...
        public void SA013()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(StringContractCodes.NotBeNullOrEmpty, result.Error.Code);
        }
        ...
        public void SA017()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(StringContractCodes.HaveLength, result.Error.Code);
        }
        ...
        public void SA019()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(StringContractCodes.StartWith, result.Error.Code);
        }
        ...
        public void SA022()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(StringContractCodes.EndWith, result.Error.Code);
        }
        ...
        public void SA024()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(StringContractCodes.Contain, result.Error.Code);
        }
        ...
        public void SA027()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(StringContractCodes.MatchRegex, result.Error.Code);
        }
        ...
        public void SA030()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(StringContractCodes.BeUpperCased, result.Error.Code);
        }
        ...
        public void SA032()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(StringContractCodes.BeLowerCased, result.Error.Code);
        }
        ...
        [Fact(DisplayName = "SA-033: Chaining multiple string contracts works")]
        public void SA033()
        {
            // Arrange
            var subject = "Hello World";
