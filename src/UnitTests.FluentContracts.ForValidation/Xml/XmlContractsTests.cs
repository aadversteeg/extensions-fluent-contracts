...
namespace UnitTests.FluentContracts.ForValidation.Xml
{
    public class XmlContractsTests
    {
        #region XDocumentContracts
        ...
        public void XML002()
        {
            ...
            Assert.Equal(XmlContractCodes.Be, result.Error.Code);
        }
        ...
        public void XML004()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(XmlContractCodes.NotBe, result.Error.Code);
        }
        ...
        public void XML006()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(XmlContractCodes.BeEquivalentTo, result.Error.Code);
        }
        ...
        public void XML009()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(XmlContractCodes.HaveRoot, result.Error.Code);
        }
        ...
        public void XML013()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(XmlContractCodes.HaveElement, result.Error.Code);
        }
        ...
        public void XML020()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(XmlContractCodes.HaveValue, result.Error.Code);
        }
        ...
        public void XML022()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(XmlContractCodes.HaveAttribute, result.Error.Code);
        }
        ...
        [Fact(DisplayName = "XML-032: Chaining XElement contracts works")]
        public void XML032()
        {
            // Arrange
        ...
        [Fact(DisplayName = "XML-033: Chaining XDocument contracts works")]
        public void XML033()
        {
            // Arrange
            var doc = XDocument.Parse("<root><child /></root>");
