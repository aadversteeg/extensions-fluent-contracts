...
namespace UnitTests.FluentContracts.ForValidation.Objects
{
    public class ObjectContractsTests
    {
        ...
        public void OA002()
        {
            ...
            Assert.Equal(ObjectContractCodes.BeNull, result.Error.Code);
        }
        ...
        public void OA004()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(ObjectContractCodes.NotBeNull, result.Error.Code);
        }
        ...
        public void OA006()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(ObjectContractCodes.Be, result.Error.Code);
        }
        ...
        public void OA008()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(ObjectContractCodes.NotBe, result.Error.Code);
        }
        ...
        public void OA010()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(ObjectContractCodes.BeSameAs, result.Error.Code);
        }
        ...
        public void OA012()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(ObjectContractCodes.NotBeSameAs, result.Error.Code);
        }
        ...
        public void OA014()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(ObjectContractCodes.BeOfType, result.Error.Code);
        }
        ...
        public void OA017()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(ObjectContractCodes.NotBeOfType, result.Error.Code);
        }
        ...
        public void OA019()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(ObjectContractCodes.BeAssignableTo, result.Error.Code);
        }
        ...
        public void OA021()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(ObjectContractCodes.NotBeAssignableTo, result.Error.Code);
        }
        ...
        public void OA023()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(ObjectContractCodes.Match, result.Error.Code);
        }
        ...
        [Fact(DisplayName = "OA-026: Chaining multiple contracts works")]
        public void OA026()
        {
            // Arrange
            object subject = "test";
