...
namespace UnitTests.FluentContracts.ForValidation.Exceptions
{
    public class ExceptionContractsTests
    {
        ...
        public void EX003()
        {
            ...
            Assert.Equal(ExceptionContractCodes.Throw, result.Error.Code);
        }
        ...
        public void EX006()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(ExceptionContractCodes.ThrowExactly, result.Error.Code);
        }
        ...
        public void EX009()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(ExceptionContractCodes.NotThrow, result.Error.Code);
        }
        ...
        public void EX016()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(ExceptionContractCodes.WithMessage, result.Error.Code);
        }
        ...
        public void EX019()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(ExceptionContractCodes.WithInnerException, result.Error.Code);
        }
        ...
        public void EX023()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(ExceptionContractCodes.Where, result.Error.Code);
        }
        ...
        public void EX024()
        {
            ...
            // Act
            var exceptionContracts = action.Should().Throw<InvalidOperationException>();
            var exception = exceptionContracts.Which;
        ...
        [Fact(DisplayName = "EX-029: Chaining fails on first failing contract")]
        public void EX029()
        {
            // Arrange
            var inner = new ArgumentException("inner");
        ...
        public void EX031()
        {
            // Arrange
            Action action = () => throw new InvalidOperationException("test");
            var contracts = action.Should().Throw<InvalidOperationException>();

            // Act & Assert
            Assert.Throws<ArgumentNullException>(() => contracts.WithInnerException(null!));
        }
        ...
        public void EX032()
        {
            ...
            // Act & Assert
            Assert.Throws<ArgumentNullException>(() => contracts.Where(null!));
        }
