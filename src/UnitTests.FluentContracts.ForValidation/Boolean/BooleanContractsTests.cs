...
namespace UnitTests.FluentContracts.ForValidation.Boolean
{
    public class BooleanContractsTests
    {
        ...
        public void BA002()
        {
            ...
            Assert.Equal(BooleanContractCodes.BeTrue, result.Error.Code);
        }
        ...
        public void BA004()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(BooleanContractCodes.BeFalse, result.Error.Code);
        }
        ...
        public void BA006()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(BooleanContractCodes.Be, result.Error.Code);
        }
        ...
        public void BA008()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(BooleanContractCodes.NotBe, result.Error.Code);
        }
        ...
        public void BA011()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(BooleanContractCodes.Imply, result.Error.Code);
        }
