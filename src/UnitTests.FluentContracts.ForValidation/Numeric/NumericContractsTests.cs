...
namespace UnitTests.FluentContracts.ForValidation.Numeric
{
    public class NumericContractsTests
    {
        #region Be / NotBe
        ...
        public void NA002()
        {
            ...
            Assert.Equal(NumericContractCodes.Be, result.Error.Code);
        }
        ...
        public void NA004()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(NumericContractCodes.NotBe, result.Error.Code);
        }
        ...
        public void NA006()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(NumericContractCodes.BePositive, result.Error.Code);
        }
        ...
        public void NA009()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(NumericContractCodes.BeNegative, result.Error.Code);
        }
        ...
        public void NA011()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(NumericContractCodes.BeGreaterThan, result.Error.Code);
        }
        ...
        public void NA013()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(NumericContractCodes.BeGreaterThanOrEqualTo, result.Error.Code);
        }
        ...
        public void NA015()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(NumericContractCodes.BeLessThan, result.Error.Code);
        }
        ...
        public void NA017()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(NumericContractCodes.BeLessThanOrEqualTo, result.Error.Code);
        }
        ...
        public void NA020()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(NumericContractCodes.BeInRange, result.Error.Code);
        }
        ...
        public void NA022()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(NumericContractCodes.NotBeInRange, result.Error.Code);
        }
        ...
        public void NA024()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(NumericContractCodes.BeOneOf, result.Error.Code);
        }
        ...
        public void NA026()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(NumericContractCodes.Match, result.Error.Code);
        }
        ...
        [Fact(DisplayName = "NA-027: Double contracts work")]
        public void NA027()
        {
            // Arrange
            var subject = 3.14;
        ...
        [Fact(DisplayName = "NA-028: Decimal contracts work")]
        public void NA028()
        {
            // Arrange
            var subject = 19.99m;
        ...
        [Fact(DisplayName = "NA-029: Long contracts work")]
        public void NA029()
        {
            // Arrange
        ...
        [Fact(DisplayName = "NA-030: Chaining multiple numeric contracts works")]
        public void NA030()
        {
            // Arrange
            var subject = 50;
