...
namespace UnitTests.FluentContracts.ForValidation.Guids
{
    public class GuidContractsTests
    {
        ...
        public void GU002()
        {
            ...
            Assert.Equal(GuidContractCodes.BeEmpty, result.Error.Code);
        }
        ...
        public void GU004()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(GuidContractCodes.NotBeEmpty, result.Error.Code);
        }
        ...
        public void GU007()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(GuidContractCodes.Be, result.Error.Code);
        }
        ...
        public void GU009()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(GuidContractCodes.NotBe, result.Error.Code);
        }
        ...
        [Fact(DisplayName = "GU-017: Chaining multiple Guid contracts works")]
        public void GU017()
        {
            // Arrange
            var subject = new Guid("12345678-1234-1234-1234-123456789012");
