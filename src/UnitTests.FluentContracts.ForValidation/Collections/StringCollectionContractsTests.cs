...
{
    public class StringCollectionContractsTests
    {
        ...
        public void SC002()
        {
            ...
            Assert.Equal(StringCollectionContractCodes.ContainMatch, result.Error.Code);
        }
        ...
        public void SC004()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(StringCollectionContractCodes.NotContainMatch, result.Error.Code);
        }
        ...
        public void SC006()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(StringCollectionContractCodes.AllMatch, result.Error.Code);
        }
        ...
        public void SC008()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(StringCollectionContractCodes.ContainEquivalentOf, result.Error.Code);
        }
        ...
        public void SC010()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(StringCollectionContractCodes.NotContainEquivalentOf, result.Error.Code);
        }
        ...
        public void SC012()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(StringCollectionContractCodes.OnlyContainNullOrEmpty, result.Error.Code);
        }
        ...
        public void SC014()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(StringCollectionContractCodes.NotContainNullOrEmpty, result.Error.Code);
        }
        ...
        public void SC017()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(StringCollectionContractCodes.Equal, result.Error.Code);
        }

        #endregion

        #region Standard Collection Contracts
        ...
        [Fact(DisplayName = "SC-025: Chaining string collection contracts works")]
        public void SC025()
        {
            // Arrange
            var subject = new List<string> { "test1", "test2", "test3" };
