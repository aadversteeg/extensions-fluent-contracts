...
namespace UnitTests.FluentContracts.ForValidation.Collections
{
    public class CollectionContractsTests
    {
        ...
        public void CA002()
        {
            ...
            Assert.Equal(CollectionContractCodes.BeEmpty, result.Error.Code);
        }
        ...
        public void CA004()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(CollectionContractCodes.NotBeEmpty, result.Error.Code);
        }
        ...
        public void CA006()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(CollectionContractCodes.HaveCount, result.Error.Code);
        }
        ...
        public void CA010()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(CollectionContractCodes.Contain, result.Error.Code);
        }
        ...
        public void CA012()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(CollectionContractCodes.NotContain, result.Error.Code);
        }
        ...
        public void CA014()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(CollectionContractCodes.ContainSingle, result.Error.Code);
        }
        ...
        public void CA017()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(CollectionContractCodes.OnlyContain, result.Error.Code);
        }
        ...
        public void CA019()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(CollectionContractCodes.BeSubsetOf, result.Error.Code);
        }
        ...
        public void CA021()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(CollectionContractCodes.HaveElementAt, result.Error.Code);
        }
        ...
        public void CA023()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(CollectionContractCodes.BeInAscendingOrder, result.Error.Code);
        }
        ...
        [Fact(DisplayName = "CA-025: Chaining multiple collection contracts works")]
        public void CA025()
        {
            // Arrange
            var subject = new List<int> { 1, 2, 3 };
