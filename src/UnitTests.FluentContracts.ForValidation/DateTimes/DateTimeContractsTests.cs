...
namespace UnitTests.FluentContracts.ForValidation.DateTimes
{
    public class DateTimeContractsTests
    {
        #region Be / NotBe
        ...
        public void DT002()
        {
            ...
            Assert.Equal(DateTimeContractCodes.Be, result.Error.Code);
        }
        ...
        public void DT004()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(DateTimeContractCodes.NotBe, result.Error.Code);
        }
        ...
        public void DT006()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(DateTimeContractCodes.BeCloseTo, result.Error.Code);
        }
        ...
        public void DT008()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(DateTimeContractCodes.NotBeCloseTo, result.Error.Code);
        }
        ...
        public void DT011()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(DateTimeContractCodes.BeBefore, result.Error.Code);
        }
        ...
        public void DT014()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(DateTimeContractCodes.BeAfter, result.Error.Code);
        }
        ...
        public void DT019()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(DateTimeContractCodes.HaveYear, result.Error.Code);
        }
        ...
        public void DT028()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(DateTimeContractCodes.BeSameDateAs, result.Error.Code);
        }
        ...
        public void DT031()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(DateTimeContractCodes.BeOneOf, result.Error.Code);
        }
        ...
        public void DT033()
        {
            ...
            // Assert
            Assert.True(result.IsFailure);
            Assert.Equal(DateTimeContractCodes.BeIn, result.Error.Code);
        }
        ...
        [Fact(DisplayName = "DT-037: Chaining multiple DateTime contracts works")]
        public void DT037()
        {
            // Arrange
